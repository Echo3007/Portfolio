        ...
        <div className="py-32 relative z-0">
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="max-w-lg mx-auto ">
                    <h1 className="font-serif text-3xl text-center mt-8 tracking-wide">Some title here</h1>
                    <p className="mt-4 text-center text-black/80">Some description here</p>
                </div>
            </div>
            <div className="flex flex-col gap-4 md:flex-row justify-center items-center mt-8 ">
                <button className="inline-flex items-center gap-2 border border-white bg-white/25 px-6 h-12 rounded-xl">
