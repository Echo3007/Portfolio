                        ...
                        >
                            <div className='lg:grid lg:grid-cols-2 lg:gap-16' >
                                ...
                                <div className='relative'>
                                    <Image unoptimized src={project.image} alt={project.title} className='mt-8 -mb-4 md:-mb-0 lg:mt-0  lg:absolute lg:h-auto lg:w-auto lg:max-w-none rounded-xl'></Image>
                                </div>
                            </div>
