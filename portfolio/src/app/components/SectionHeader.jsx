        ...
        <>
            <div className='flex justify-center'>
                <p className='uppercase font-semibold tracking-widest bg-gradient-to-r from-red-500 
                    ...
                    bg-clip-text text-transparent text-center text-shadow-xs md:text-lg lg:text-xl'>{eyebrow}</p>
            </div>
            <h2 className='font-serif text-3xl md:text-5xl  text-center mt-6'>{title}</h2>
            <p className='text-center md:text-lg lg:text-xl text-black/80 mt-4 max-w-md mx-auto'>{description}</p>
        </>
    )
}